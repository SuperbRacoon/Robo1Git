...
ImageOverlay()
    : Node("tutorial_9_3_2")
{
    background_ = cv::imread("/home/hugh/ros2_ws/src/tut_9/images/car_junction_gazebo.png", cv::IMREAD_UNCHANGED);
    foreground_ = map("/home/hugh/ros2_ws/src/tut_9/images/car_junction_map2.pgm");
